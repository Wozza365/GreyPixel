...
public:
  ...
  void blank();
  void clearDisplay();
  void display(uint8_t bufferNum);
  ...
  void copyScreen(const uint8_t *bitmap, uint8_t bufferNum);
  
private:
  unsigned char sBuffer0[(HEIGHT*WIDTH)/8];
  unsigned char sBuffer1[(HEIGHT*WIDTH)/8];
